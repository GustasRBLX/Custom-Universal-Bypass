...
const ODP=(t,p,o)=>{try{Object.defineProperty(t,p,o)}catch(e){console.trace("[Gustas Custom Universal Bypass] Couldn't define",p)}},
...
domainBypass=(domain,f)=>{
	...
	{
		console.error("[Gustas Custom Universal Bypass] Invalid domain:",domain)
	}
},
hrefBypass=(regex,f)=>{
	if(bypassed)
